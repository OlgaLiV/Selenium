...
public class HandlingPagination2 {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		firstName.sendKeys("Baby");
		lastName.sendKeys("Shark");
		WebElement empId = driver.findElement(By.id("employeeId"));
		String emp = empId.getAttribute("value");
		...
		while (flag) {
			...
			for (int i = 0; i < rows.size(); i++) {
				...
				if (rowText.contains(emp)) {
					flag = false;
					// getting i from iteration and locating only checkbox
